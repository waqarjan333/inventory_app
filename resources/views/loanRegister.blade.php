...
<div id="appCapsule">
    <div class="section mt-1">
        <div class="section-title text-center">
            ...
            {{ $acc_id->acc_name.$flag }}
            @if(count($accounts_array)>0)
                <a href="{{ route('show.Loan.Register.Pay', $acc_id->acc_id) }}" class="btn btn-primary" style="float:right; margin-top:-5px;">Pay</a>
            @endif
        </div>
