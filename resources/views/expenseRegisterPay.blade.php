...
<div id="appCapsule">
    <div class="section" style="background-color: #FFFFFF;">
        ...
        <div class="transactions">
            <form method="POST" action="{{ route('expense.Register.Payment') }}">@csrf
                <div class="form-group basic">
                    <label class="label">Date</label>
                    <div class="input-group date">
                        <input type="text" class="form-control text-success" value="{{ old('date_paid') }}" name="date_paid" id="expense_register_pay_date" />
                    </div>
